...
#include <mega32.h>
#define led_blue  PORTA.0
#define led_red   PORTA.1
#define led_test  PORTB.2
unsigned int speed_blue = 1;
unsigned int speed_red = 2;
...
// PlaceI your code here
if (PIND.1 == 0)
{ 


        if (speed_blue>=1 && speed_blue <=4)
        {
            speed_blue++;
        };
